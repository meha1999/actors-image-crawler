...
class IranianActorImageProcessor:
    ...
    def stage3_actor_identification(self, actor_name):
        ...
        try:
            ...
            # Step 4: Filter images based on similarity to reference
                ...
                try:
                    ...
                    if similarity >= self.IDENTITY_THRESHOLD:
                        ...
                        if correct_actor_count % 20 == 0:
                            print(f"✅ Saved {correct_actor_count} images of {actor_name}")
    ...
    def process_actor_complete(self, actor_name):
        ...
        print(f"   📈 Success rate: {(final_count/max(1, with_faces))*100:.1f}%")
    ...
    def process_all_actors(self):
        ...
        print(f"   3️⃣ Actor Identification: Use clustering to keep only correct actor images")
