...
class IranianActorImageProcessor:
    def __init__(self, input_dir="iranian_actors_dataset", output_dir=None):
        ...
        os.makedirs(
            f"{self.output_dir}/errors/stage3_duplicates", exist_ok=True)
    ...
    def stage3_actor_identification(self, actor_name):
        ...
        try:
                ...
                try:
                    ...
                    if similarity >= self.IDENTITY_THRESHOLD:
                        ...
                        if is_duplicate:
                            ...
                            shutil.copy(img_path, os.path.join(
                                duplicates_dir, os.path.basename(img_path)))
                            duplicate_count += 1
                            ...
                            if correct_actor_count % 50 == 0:
                                print(
                                    f"✅ Saved {correct_actor_count} unique images of {actor_name}")
                    else:
            ...
            print(
                f"   📈 Success rate: {(correct_actor_count/(len(valid_paths)-encoding_errors))*100:.1f}%")
    ...
    def process_actor_complete(self, actor_name):
        ...
        print(
            f"   📈 Overall success rate: {(final_count/max(1, with_faces))*100:.1f}%")
    ...
    def process_all_actors(self):
        ...
        print(
            f"   3️⃣ Actor Identification: Use clustering to keep ALL correct actor images")
